        ...
        <table className="vendor-table" style={{ tableLayout: 'fixed', width: '850px', marginBottom: '1rem' }}>
            <thead>
                <tr>
                    ...
                    <th style={{ width: '70px' }}>申請編號</th>
                    <th style={{ width: '80px' }}>申請日期</th>
                    <th style={{ width: '70px', textAlign: 'center' }}>狀態</th>
                    <th style={{ width: '60px', textAlign: 'center' }}>類型</th>
                    <th style={{ width: '70px', textAlign: 'center' }}>申請人</th>
                    <th style={{ width: '100px', textAlign: 'center' }}>付款對象</th>
                    {showApprover && <th style={{ width: '80px', textAlign: 'center' }}>審核者</th>}
                    <th style={{ width: '140px' }}>說明</th>
                    <th style={{ width: '80px', textAlign: 'center' }}>金額</th>
                    {payments && <th style={{ width: '80px' }}>付款日期</th>}
                    {renderActions && <th style={{ width: '60px', textAlign: 'right' }}>操作</th>}
                </tr>
            </thead>
            <tbody>
                {loading ? (
